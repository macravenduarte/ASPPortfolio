...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!-- Use glyph icons about each paragraph in the about me section.
        Source: http://www.w3schools.com/bootstrap/bootstrap_ref_comp_glyphs.asp-->
                <div class="col-sm-2">
                    <span id="aboutmeicon1" class="glyphicon glyphicon-education logo"></span>
                    <p>I am a junior computer programmer with lots to offer almost any project</p>
                </div>
                <div class="col-sm-2">
                    <span id="aboutmeicon2" class="glyphicon glyphicon-sunglasses logo"></span>
                    <p>I am very sociable, hard working, and a team player</p>

                </div>
                <div class="col-sm-2">
                    <span id="aboutmeicon3" class="glyphicon glyphicon-list-alt logo"></span>
